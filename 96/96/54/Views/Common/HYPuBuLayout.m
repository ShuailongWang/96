...
#import "HYPuBuLayout.h"

@interface HYPuBuLayout()

@property (nonatomic, strong) NSMutableDictionary *maxYDic;//用来记录每一列的最大y值
@property (nonatomic, strong) NSMutableArray *attributesArray;//保存每一个item的attributes

@end

@implementation HYPuBuLayout
...
#pragma mark- 一口气设置列间距，行间距，sectionInset
